---
title: プロジェクト契約品目の複数の顧客を管理する
description: この記事では、プロジェクト ベースの契約品目で複数の顧客を管理するための情報を提供します。
author: rumant
ms.date: 10/27/2020
ms.topic: article
...
ms.locfileid: "9825946"
---
# <a name="manage-multiple-customers-on-project-contract-lines"></a>プロジェクト契約品目の複数の顧客を管理する
