...
## <a name="using-journals-to-record-costs"></a>ジャーナルを使用してコストを記録する

PSA では仕訳帳を使用して、材料、料金、時間、経費、税のトランザクション クラスでコストや収益を記録できます。 ジャーナルには、ヘッダー、行、**確認** の操作があります。 以下にジャーナルを使用するシナリオをいくつか示します。
