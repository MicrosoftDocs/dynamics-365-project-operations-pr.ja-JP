...
[!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [電話用およびタブレット PC 用の Dynamics 365 のインストール](../mobile-app/install-dynamics-365-for-phones-and-tablets.md)。
...
[!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [モバイル基本ガイド](../mobile-app/dynamics-365-phones-tablets-users-guide.md).
