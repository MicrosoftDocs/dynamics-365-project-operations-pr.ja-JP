...
2. 次の表に記載されている順番通りに、ソリューションを削除します。 
    ...
    | 9 | FieldServiceCommon                                 | Dynamics 365 Finance または Dynamics 365 Supply Chain Management での二重書き込みに必要です。   |
    | 10 | msdyn_AssetCommon                                  | Dynamics 365 Finance または Dynamics 365 Supply Chain Management での二重書き込みに必要です。   |
