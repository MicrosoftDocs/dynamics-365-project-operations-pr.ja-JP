...
3. <span data-ttu-id="ff7b4-142">**すべて選択** をクリックし、**パッケージの保存** を選択します。</span><span class="sxs-lookup"><span data-stu-id="ff7b4-142">Click **Select all** and then select **Save package**.</span></span>
