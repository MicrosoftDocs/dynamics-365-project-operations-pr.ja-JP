...
- Dynamics 365 Finance 環境のプロジェクト管理および会計には、経費管理機能、プロジェクト会計、収益認識が含まれます。 財務と運用アプリの環境は、リソース/非在庫ベースのシナリオ向け Project Operations と、在庫/運用ベースのシナリオ向け Project Operations で使用されます。

## <a name="project-operations-release-notes"></a>Project Operations リリース ノート
- [リソース/在庫なし](whats-new-july-2022-resource-based.md) シナリオに関する Project Operations 最新リリース ノート。
- [ライト展開](../pro/whats-new/whats-new-july-2022-lite.md) シナリオに関する Project Operations 最新リリース ノート。
- [在庫/製造](../prod-pma/whats-new/whats-new-jul-2022-stocked.md) シナリオに関する Project Operations 最新リリース ノート。
...
|サポートされるバージョン| プレビューの有無 | 一般提供 (自己更新) | 自動更新スケジュール (LCS 更新設定による) 生産開始日 |   サービスの終了   |
|:---------------:|:---------------------------:|:---------------------------------:|:--------------------------------------------------------------------:|:------------------:|
...
|対象バージョン | プレビューの有無 | 一般提供 (自己更新) | 自動更新スケジュール (LCS 更新設定による) 生産開始日 |   サービスの終了   |
|:---------------:|:---------------------------:|:---------------------------------:|:--------------------------------------------------------------------:|:------------------:|
