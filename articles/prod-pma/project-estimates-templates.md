---
title: Project Service Automation から財務と運用にプロジェクトの見積もりを直接同期する
...
ms.locfileid: "9029811"
---
# <a name="synchronize-project-estimates-directly-from-project-service-automation-to-finance-and-operations"></a>Project Service Automation から財務と運用にプロジェクトの見積もりを直接同期する
