---
title: 財務と運用と Project Service Automation の間でプロジェクト経費カテゴリを同期する
...
ms.locfileid: "9028938"
---
# <a name="synchronize-project-expense-categories-between-finance-and-operations-and-project-service-automation"></a>財務と運用と Project Service Automation の間でプロジェクト経費カテゴリを同期する
