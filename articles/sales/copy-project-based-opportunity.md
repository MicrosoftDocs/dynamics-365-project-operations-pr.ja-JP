---
title: プロジェクトの営業案件をコピーする
description: この記事では、Project Operations のプロジェクトベースの営業案件をコピーする方法について説明します。
author: rumant
ms.date: 10/09/2020
ms.topic: article
...
ms.locfileid: "9826134"
---
# <a name="copy-project-opportunities"></a>プロジェクトの営業案件をコピーする
