...
6. Adventure Works のプロジェクトに移動して **関連** > **実績** を順に選択します。 以下の実績トランザクションが作成されます。
...
11. **プロジェクトの管理と会計** > **定期的** > **Customer Engagement の Project Operations** > **ステージングからインポートする** に移動し、定期的なプロセスを実行して Project Operations 統合仕訳帳に記入します。
