...
ms.locfileid: "3897907"
---
# <a name="estimating-projects-home-page"></a>プロジェクトのホームページの見積もり
...
プロジェクト オペレーションでは、契約またはプロジェクトの受注変更に対応していません。

## <a name="estimating-projects"></a>見積もりプロジェクト

プロジェクトの時間と費用を見積もることができます。 プロジェクト オペレーションでは、プロジェクトの原料や費用の見積もりには対応していません。
