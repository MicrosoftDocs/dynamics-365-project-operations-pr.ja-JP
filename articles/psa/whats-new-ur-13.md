...
description: この記事では、Project Service Automation 更新プログラム リリース 13、V3 で新しい点について説明します。
author: ruhercul
...
この記事では、Project Service Automation V3 更新プログラム リリース 13 の機能と修正を一覧表示します。 このバージョンのビルド番号は V3.10.3.18 であり、次のスケジュールで入手できます:
